...
const buttonVariants = cva(
  ...
  {
    variants: {
      variant: { default: "bg-primary text-primary-foreground hover:bg-primary-hover", outline: "border bg-background hover:bg-muted", ghost: "hover:bg-muted", danger: "bg-danger text-white hover:bg-red-700" },
